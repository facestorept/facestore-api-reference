# Facestore OpenAPI Specification
[![Build Status](https://travis-ci.org/facestorept/facestore-api-reference.svg?branch=master)](https://travis-ci.org/facestorept/facestore-api-reference)
...
6. If you did everything correct, https://facestorept.github.io/facestore-api-reference/ will lead to your new docs
...
- Documentation(ReDoc): https://facestorept.github.io/facestore-api-reference/
- Look full spec:
    + JSON https://facestorept.github.io/facestore-api-reference/swagger.json
    + YAML https://facestorept.github.io/facestore-api-reference/swagger.yaml
- Preview spec version for branch `[branch]`: https://facestorept.github.io/facestore-api-reference/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://facestorept.github.io/facestore-api-reference/ with url from the message: `Server started <url>`
